    ...
    <div className="min-h-screen bg-slate-50 p-6 md:p-12">
        ...
        <div className="flex justify-between items-end mb-10">
          <div>
            <h1 className="text-4xl font-black text-slate-900 tracking-tighter italic">
              GetInv<span className="text-blue-600">.</span> Directory
            </h1>
                  ...
                  <td className="px-8 py-6">
                    <div className="flex items-center justify-end gap-2">
                      <Link
                        ...
                        className="inline-flex items-center gap-2 text-xs font-bold text-blue-600 bg-blue-50 px-4 py-2 rounded-xl hover:bg-blue-600 hover:text-white transition-all"
                      >
      ...
      {archivedClients.length > 0 && (
        <details className="mt-12 group">
          ...
          <div className="mt-4 bg-white rounded-[2rem] border border-slate-100 overflow-hidden shadow-sm opacity-60 hover:opacity-100 transition-opacity">
            <table className="w-full text-left">
              <tbody className="divide-y divide-slate-50">
